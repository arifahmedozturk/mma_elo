...
class EloHelper:
    ...
    def get_age_penalty(self, dob, last_age_penalty, fight_date):
        ...
        return -1*50*(age_at_fight - max(37, age_at_penalty))
    ...
    def get_elo_changes(self, fighter, opponent, fight):
        ...
        fighter_transformed_elo = math.pow(10, fighter_elo/400)
        opponent_transformed_elo = math.pow(10, opponent_elo/400)
        ...
        fighter_new_elo = int(fighter_elo + fighter_result_penalty + 128 * (fighter_result_score - fighter_expected_score))
        opponent_new_elo = int(opponent_elo + opponent_result_penalty + 128 * (opponent_result_score - opponent_expected_score))
